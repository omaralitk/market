...
import 'package:market1/Model/product.dart';
import 'package:market1/View/Login_Screen.dart';
import 'package:market1/View/details_product.dart';
                ...
                child: Card(
                  child: ListTile(
                    leading: Container(
                        ...
                        child: Image.asset('assets/images/omar.jpg')),
                    title: Text('Omar Ali '),
                  ),
                ),
              ),
